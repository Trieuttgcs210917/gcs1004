                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div style="margin-right: 5%; margin-bottom: 20px; float:right">
                                        <a href="{{ route('addAdmin') }}" class="btn btn-primary">Add
                                            admin</a>
                                    </div>
                                        ...
                                        <tbody>
                                            @foreach ($data as $admin)
                                                <tr>
                                                    <td>{{ $admin->adminID }}</td>
                                                    <td>
                                                        <Textarea>{{ $admin->adminPass }}</Textarea>
                                                    </td>
                                                    <td>{{ $admin->adminFullname }}</td>
                                                    <td><img src="{{ asset('admin/assets/pro_img/' . $admin->adminPhoto) }}"
                                                            alt="" style="border-radius: 0%"></td>
                                                    <td>
                                                        <a href="{{ url('admin/editAdmin/' . $admin->adminID) }}"
                                                            title="Edit this admin"><i
                                                                class="fa-solid fa-pen-to-square"></i></a> &nbsp;
                                                        <a href="{{ url('admin/deleteAdmin/' . $admin->adminID) }}"
