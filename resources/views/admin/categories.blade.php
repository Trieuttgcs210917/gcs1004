                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div style="margin-right: 5%; margin-bottom: 20px; float:right">
                                        <a href="{{ route('addCategory') }}" class="btn btn-primary">Add
                                            category</a>
                                    </div>
                                        ...
                                        <tbody>
                                            @foreach ($data as $category)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <Textarea>{{ $category->catDescriptions }}</Textarea>
                                                    </td>
                                                    <td>
                                                        <a href="{{ url('admin/editCategory/' . $category->catID) }}"
                                                            title="Edit this category"><i
                                                                class="fa-solid fa-pen-to-square"></i></a> &nbsp;
                                                        <a href="{{ url('admin/deleteCategory/' . $category->catID) }}"
