    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href={{url('customers/index')}}><img src="../admin/assets/images/logo.svg" alt="logo" /></a>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href='{{url('admin/products')}}'>
                <span class="icon-bg"><i class="fa fa-angle-double-down" style="font-size:24px;color:#49be25"></i></i></span>
                  ...
                  <div>
                    <div class="d-flex align-items-center">
                      <div class="sidebar-profile-img">
                        <img src="assets/pro_img/{{Session::get('adminPhoto')}}" alt="image" width="20px" height="20px">
                      </div>
                    ...
                    <tbody>
                        @foreach ($data as $product)
                            <tr>
                                ...
                                <td><img src="{{asset('admin/assets/pro_img/'.$product->productImage)}}" alt="" style="border-radius: 0%"></td>
                                <td>{{$product->productDetails}}</td>
                                <td>{{$product->catName}}</td>
                                <td>
                                    <a href="{{url('admin/edit/'.$product->productID)}}" title="Edit this product"><i class="fa-solid fa-pen-to-square"></i></a> &nbsp;
                                    <a href="{{url('admin/delete/'.$product->productID)}}" title="Delete this product"><i class="fa-solid fa-trash-can"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
