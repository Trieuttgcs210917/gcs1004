                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ url('admin/updateAdmin') }}" method="POST">
                                        ...
                                        <div class="mb-3 mt-3">
                                            ...
                                            <input value="{{ $eAdm->adminID }}" readonly type="id"
                                                class="form-control" id="id" placeholder="Enter id"
                                                name="id">
                                        </div>
                                        <div class="mb-3 mt-3">
                                            <label for="pass">Password:</label>
                                            <input value="{{ $eAdm->adminPass }}" type="text"
                                                class="form-control" id="pass" placeholder="Enter password"
                                                name="pass">
                                        </div>
                                        <div class="mb-3 mt-3">
                                            <label for="name">admin Name:</label>
                                            <input value="{{ $eAdm->adminFullname }}" type="text"
                                                class="form-control" id="name" placeholder="Enter admin name"
                                                name="name">
                                        </div>
                                        <div class="mb-3 mt-3">
                                            ...
                                            <input type="file" class="form-control" id="photo"
                                                name="photo">
                                            <input value="{{ $eAdm->adminPhoto }}" readonly type="text"
                                                class="form-control" id="oldphoto" name="oldphoto">
                                        </div>
                                        <button type="update" class="btn btn-primary">Update</button>
                                        <a href="{{ url('admin/admins') }}" class="btn btn-danger"> Back </a>
                                    </form>
                                </div>
                            </div>
                        </div>
